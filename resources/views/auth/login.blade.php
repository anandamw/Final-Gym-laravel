        ...
        <div class="main-content d-flex flex-column px-0">
            ...
            <div class="m-auto mw-510 py-5">
                <form action="/login" method="POST">
                    ...
                    <p class="fs-18 mb-5">Don’t have an account? <a href="/register"
                        ...
                        <div class="card-body p-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="username" name="username" value="{{ old('username') }}"
                                    class="form-control h-58" placeholder="Your username">
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="password-wrapper position-relative">
                                        <input type="password" name="password" id="password"
                                            class="form-control h-58 text-dark" value="{{ old('password') }}"
