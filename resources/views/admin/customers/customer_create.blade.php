                        ...
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                            ...
                            <form class="row g-3 needs-validation" method="POST" action="/customer/create" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control h-58 ps-5" id="nomer_whatsapp"
                                            name="nomer_whatsapp" placeholder="Your Phone Number ......." required />
                                        <div class="valid-feedback">Looks good!</div>
                                        <i class="ri-user-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                                            style="top: 13px !important"></i>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control h-58 ps-5" id="email"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <select name="status" class="form-select form-control h-58 ps-5" id="status" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="position-relative">
                                        <select name="pakets_id" class="form-select form-control h-58 ps-5" id="paket" required>
