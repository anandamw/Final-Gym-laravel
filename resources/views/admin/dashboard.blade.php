                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            ...
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/planning-1.jpg" class="rounded-3 wh-44"
                                                    alt="planning">
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            class="d-flex align-items-center rounded-3 bg-gray-div2 p-3 p-sm-2 p-md-3 mb-15">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/planning-2.jpg" class="rounded-3 wh-44"
                                                    alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            ...
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/planning-3.jpg" class="rounded-3 wh-44"
                                                    alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div class="d-flex align-items-center rounded-3 bg-gray-div2 p-3 p-sm-2 p-md-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/planning-4.jpg" class="rounded-3 wh-44"
                                                    alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-1.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-2.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-3.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-4.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-5.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-8.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-6.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="assets/images/course-7.jpg" class="rounded-3 wh-75"
                                                                alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled messages-list" data-simplebar>
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="assets/images/user-20.jpg" class="rounded-3 border border-color-gray2"
                                            alt="user">
                                        <div
                        ...
                        <li class="border-color-gray border-bottom p-4 active" id="my-element2">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="assets/images/user-21.jpg" class="rounded-3 border border-color-gray2"
                                            alt="user">
                                        <div
                        ...
                        <li class="border-color-gray border-bottom p-4" id="my-element3">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="assets/images/user-22.jpg" class="rounded-3 border border-color-gray2"
                                            alt="user">
                                        <div
                        ...
                        <li class="p-4" id="my-element4">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="assets/images/user-23.jpg" class="rounded-3 border border-color-gray2"
                                            alt="user">
                                        <div
                    ...
                    <div class="row justify-content-center gx-3">
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-14.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-15.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-16.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-17.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-18.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12 c-mt-15">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mt-3 mt-md-0">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-19.jpg" class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
